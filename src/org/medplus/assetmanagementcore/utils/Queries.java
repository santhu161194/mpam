...
public class Queries {
	...
	public static String addNewAsset = "insert into assetmanagement.tbl_asset(SerialNumber,AssetName,AssetType,Cost,Status,CreatedBy,DateCreated,Model) values(?,?,?,?,?,?,?,?)";
